...
AGL_toolchain_create_sdk_env_script () {
	...
	script=${1:-${SDK_OUTPUT}/${SDKPATH}/AGL-environment-setup-$multimach_target_sys}
	rm -f $script
	touch $script
	...
	AGL_toolchain_shared_env_script
}

# This function creates an environment-setup-script in the TMPDIR which enables
# a OE-core IDE to integrate with the build tree
AGL_toolchain_create_tree_env_script () {
	script=${TMPDIR}/AGL-environment-setup-${REAL_MULTIMACH_TARGET_SYS}
	rm -f $script
	touch $script
